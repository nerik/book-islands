...
const cmd = `tippecanoe -o ${p}.mbtiles --minimum-zoom=3 --maximum-zoom=${MAX_ZOOM_GENERATED} --base-zoom=5 --named-layer='author_labels':${TERRITORY_LABELS} --named-layer='books_labels':${BOOKS_POINTS}`
console.log(cmd)
exec(cmd)
