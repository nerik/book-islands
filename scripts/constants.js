module.exports = {
  ...
  BASE_CITIES: 'out/baseIslands/cities.json',
  UMAP_GEO: 'out/umap/umap.geo.json',
  UMAP_GEO_CLUSTER: 'out/layout/umap_cluster.geo.json',
  CLUSTERS: 'out/layout/clusters.geo.json',
  BASE_ISLANDS_CLUSTER_SCORES: 'out/layout/baseIslandsClusterScores.json',
  DB: 'out/db/authors.json',
